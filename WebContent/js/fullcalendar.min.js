...
(function(m, oa) {
	...
	function Zb(a, b) {
		function e() {
			q = b.theme ? "ui" : "fc";
			if (b.header)
				return Q = m("<div class='fc-header' style='width:100%'/>")
						.append(
								m("<div>").append(f("left"))
										...
										m
												.each(
														...
														function(ra, sa) {
															if (sa == "title") {
																fa
																		.append("<span class='fc-header-title'><strong>&nbsp;</strong></span>");
																ga
																		&& ga
																				.addClass(q
																						+ "-corner-right");
...
//				"七月", "八月", "九月", "十月", "十一月","十二月" 
		...
		monthNamesShort : [ "1月", "2月", "3月", "4月", "5月", "6月",
		    				"7月", "8月", "9月", "10月", "11月","12月"],
		dayNames : [ "<font color='red'>星期日</font>","星期一", "星期二", "星期三", "星期四", "星期五","<font color='red'>星期六</font>"],
		dayNamesShort : [ "<font color='red'>周日</font>", "周一", "周二", "周三", "周四", "周五", "<font color='red'>周六</font>" ],
		buttonText : {
			prev : "",
			next : "",
			prevYear : "&nbsp;&lt;&lt;&nbsp;",
	...
	Aa.formatDate = Oa;
	Aa.formatDates = ib;
	var lc = [ "<font color='red'>日</font>", "一", "二", "三", "四", "五", "<font color='red'>六</font>" ], Ab = 864E5, cc = 36E5, wc = 6E4, dc = {
		s : function(a) {
			return a.getSeconds()
		},
		ss : function(a) {
		...
		t : function(a) {
			return a.getHours() < 12 ? "上午" : "下午"//"a" : "p"
		},
		tt : function(a) {
			return a.getHours() < 12 ? "上午" : "下午"//"am" : "pm"
		},
		T : function(a) {
			return a.getHours() < 12 ? "上午" : "下午"//"A" : "P"
		},
